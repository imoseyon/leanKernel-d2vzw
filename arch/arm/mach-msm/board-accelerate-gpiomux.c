...
static struct gpiomux_setting vol_up_key_active_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_8MA,
	.pull = GPIOMUX_PULL_UP,
};

static struct gpiomux_setting vol_up_key_suspend_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_8MA,
	.pull = GPIOMUX_PULL_NONE,
};

static struct gpiomux_setting vol_down_key_active_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_8MA,
	.pull = GPIOMUX_PULL_UP,
};

static struct gpiomux_setting vol_down_key_suspend_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_8MA,
	.pull = GPIOMUX_PULL_NONE,
};
...
struct msm_gpiomux_config msm8960_gpiomux_configs[] = {
	{
		.settings = {
			[GPIOMUX_ACTIVE] = &vol_up_key_active_cfg,
			[GPIOMUX_SUSPENDED] = &vol_up_key_suspend_cfg,
		}
	},
	{
		.settings = {
			[GPIOMUX_ACTIVE] = &vol_down_key_active_cfg,
			[GPIOMUX_SUSPENDED] = &vol_down_key_suspend_cfg,
		}
	},
};
...
int __init msm8960_init_gpiomux(void)
{
	...
	if (system_rev >= GPIO_REV_MAX)
		...
		msm8960_gpiomux_configs[0].gpio = gpio_rev(VOLUME_UP);
		msm8960_gpiomux_configs[1].gpio = gpio_rev(VOLUME_DOWN);
	}
