...
#include "mach/board-kenos-camera.h"
#include "pm-boot.h"
...
static struct pm8921_adc_amux pm8921_adc_channels_data[] = {
	...
	{"dev_mpp_7", ADC_MPP_1_AMUX6, CHAN_PATH_SCALING1, AMUX_RSV1,
		ADC_DECIMATION_TYPE2, ADC_SCALE_DEFAULT},  /*main_thm */
};
...
static struct platform_device *kenos_devices[] __initdata = {
	&msm8960_device_otg,
	&msm8960_device_gadget_peripheral,
	&msm_device_hsusb_host,
	&android_usb_device,
...
static void __init samsung_kenos_init(void)
{
#ifdef CONFIG_SEC_DEBUG
	sec_debug_init();
#endif
...
/*	msm8960_device_qup_spi_gsbi1.dev.platform_data =
	...
	platform_add_devices(common_devices, ARRAY_SIZE(common_devices));
	pm8921_gpio_mpp_init();
	platform_add_devices(kenos_devices, ARRAY_SIZE(kenos_devices));
	msm8960_init_cam();
	msm8960_init_mmc();
	acpuclk_init(&acpuclk_8960_soc_data);
	if (machine_is_msm8960_liquid())
...
MACHINE_START(JAGUAR, "SAMSUNG KENOS")
	.map_io = msm8960_map_io,
	.reserve = msm8960_reserve,
	.init_irq = msm8960_init_irq,
	.timer = &msm_timer,
	.init_machine = samsung_kenos_init,
	.init_early = msm8960_allocate_memory_regions,
