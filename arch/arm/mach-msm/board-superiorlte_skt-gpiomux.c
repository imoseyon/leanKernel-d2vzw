...
static struct gpiomux_setting max77693_suspend_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
};

static struct gpiomux_setting max77693_active_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
};

static struct msm_gpiomux_config msm8960_max77693_configs[] __initdata = {
	{
		.gpio = GPIO_IF_PMIC_IRQ,
		.settings = {
			[GPIOMUX_ACTIVE]	= &max77693_active_cfg,
			[GPIOMUX_SUSPENDED] = &max77693_suspend_cfg,
		},
	},

	{
		.gpio = GPIO_IF_PMIC_SDA,
		.settings = {
			[GPIOMUX_ACTIVE]	 = &max77693_active_cfg,
			[GPIOMUX_SUSPENDED] = &max77693_suspend_cfg,
		},
...
#endif
#ifdef CONFIG_MFD_MAX77693
	msm_gpiomux_install(msm8960_max77693_configs,
			ARRAY_SIZE(msm8960_max77693_configs));
#endif
