...
cp drivers/net/wireless/bcmdhd/dhd.ko zip/system/lib/modules
cp drivers/net/wireless/btlock/btlock.ko zip/system/lib/modules
cd cm.ramdisk
chmod 750 init*
...
cd ../zip
zip -r lk_aosp_testv${1}.zip *
mv lk_aosp_testv${1}.zip /tmp
