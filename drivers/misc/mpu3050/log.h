...
/*
 * Simplified macro to send a warning log message using the 
 * current MPL_LOG_TAG.
 */
#ifndef MPL_LOGW
#ifdef __KERNEL__
...
/*
 * Simplified macro to send an error log message using the 
 * current MPL_LOG_TAG.
 */
#ifndef MPL_LOGE
#ifdef __KERNEL__
...
#elif defined __KERNEL__
/* not allowed in the Kernel because there is no dev_dbg 
