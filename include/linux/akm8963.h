...
/*! @{*/
#define AK8963_CNTL1_SNG_MEASURE	0x11 //16bit resolution set
#define	AK8963_CNTL1_SELF_TEST		0x18 //16bit resolution set
#define	AK8963_CNTL1_FUSE_ACCESS	0x1F //16bit resolution set
#define	AK8963_CNTL1_POWER_DOWN		0x10 //16bit resolution set
