...
/*                               Configuration                                */
/*----------------------------------------------------------------------------*/
#ifdef YAS_ACC_DRIVER_LIS3DH
#define YAS_ACC_DRIVER                      (YAS_ACC_DRIVER_LIS3DH)
#elif YAS_ACC_DRIVER_BMA250
...
#define YAS_MAGCALIB_DISTORTION_LV1	(500)
#define YAS_MAGCALIB_DISTORTION_LV2	(350)
#define YAS_MAGCALIB_DISTORTION_LV3	(15)
